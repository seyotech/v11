// // TODO: remove the file as it's not used
...
//  */
// const graphFetch = async (queryOptions, options) => {
//     const { mutation = false, ...restOfOpts } = isObject(options)
//         ? options
//         : { mutation: options };

//     const multiQueryOptions = isObject(queryOptions)
//         ? [queryOptions]
//         : queryOptions;
...
//         ${queries}
//     }`;
//     const body = JSON.stringify({ query, variables: variableStack });
//     return asyncFetch(GRAPHQL_API_URL, body, restOfOpts);
// };
